...
#'
#' Fits a Gaussian copula to the covariate data, constructs a full correlation
#' matrix for the covariates and outcome, and generates outcome rank samples
#' by conditioning on the simulated covariate ranks.
#'
...
#'   data (assumed to be marginally uniform).
...
#' @return A list containing:
#' \describe{
#'   \item{gaussianCopulaFit}{The fitted Gaussian copula model}
...
#'
#' Fits a Gaussian copula to the covariate data, constructs a full correlation
#' matrix for the covariates and outcome, transforms conditional ranks to
#' marginal ranks, and generates outcome rank samples.
#'
